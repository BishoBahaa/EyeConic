...
class PatForgetPassword extends StatefulWidget {
  const PatForgetPassword({Key? key}) : super(key: key);

  @override
  State<PatForgetPassword> createState() => _PatForgetPasswordState();
}

class _PatForgetPasswordState extends State<PatForgetPassword> {
  ...
  Future<void> _sendCode() async {
    if (_emailFormKey.currentState!.validate()) {
      PatientApiService().sendForgetCode(emailController.text, context);
    }
  }
  ...
  Future<void> _resetPassword() async {
    if (_resetFormKey.currentState!.validate()) {
      ...
      PatientApiService().resetPassword(reset, context);
    }
  }
